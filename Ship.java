...
public class Ship extends Actor
{
    ...
    /**
     * Ship is the default constructor for objects of 
     */
    public Ship()
    {
    ...
    /**
     * checkSetting ensures that the Ships are placed in the correct location
     * due to the fact that world uses cells fo 1 pixel by 1 pixel
     * 
     * @param There are no parameters
